...
const listarinscriptos = () => {
    try {
        listaInscritos = require('./listadoinscriptos.json');
    } catch (error) {
        listaInscritos = [];
    }
}
...
const eliminarInscripto = (idx, cursox) => {
    listarinscriptos();
